...
CHAPTERS = [
 ...
 ("Shipwright", "Everything else is gated behind this", "minecraft:oak_boat", [
  ...
  (2, 0, "Assemble",
   ...
   [r_xp(60), r_skill(3)]),
  (4, 0, "Under Sail",
   ["Craft and mount a sail.",
    "Wind changes direction over time and picks up in storms."],
   [t_check("Mount a sail on your ship")],
   [r_xp(40), r_skill(2)]),
  (6, 0, "Blue Water",
 ...
 ("Provision", "Between fights", "minecraft:bread", [
  ...
  (6, 0, "A Full Net",
   ...
   [r_xp(60), r_skill(3)]),
  (8, 0, "Out Of Season",
   ["Harvest a crop that only grows in one season.",
    "",
    "Fabric Seasons is installed. The calendar matters."],
   [t_check("Harvest a seasonal crop")],
   [r_xp(80), r_skill(4)]),
 ]),
